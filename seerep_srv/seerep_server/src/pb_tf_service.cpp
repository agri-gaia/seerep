...
grpc::Status PbTfService::TransferTransformStamped(
    grpc::ServerContext* context, const seerep::pb::TransformStamped* transform,
  ...
  if (!transform->header().uuid_project().empty())
  {
    ...
    try
    {
      ...
      seerep_server_util::createResponsePb(
          "added transform", seerep::pb::ServerResponse::SUCCESS, response);
...
grpc::Status PbTfService::GetFrames(grpc::ServerContext* context,
...
grpc::Status PbTfService::GetTransformStamped(
