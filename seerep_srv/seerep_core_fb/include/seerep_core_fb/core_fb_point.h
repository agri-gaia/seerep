...
public:
   ...
   * @param writer the writer object used to send the points matching the query
   * directly via gRPC
   *
   * Based on the query the indices are used to get the uuids of the points
   * matching the query. Then the points are loaded by the hdf5-fb-io and send
...
private:
  ...
  std::unordered_map<boost::uuids::uuid,
                     std::shared_ptr<seerep_hdf5_fb::Hdf5FbPoint>,
