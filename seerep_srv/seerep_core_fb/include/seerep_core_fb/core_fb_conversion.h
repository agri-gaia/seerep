...
/**
 * @brief This class converts between flatbuffer messages and seerep core
 * specific messages
 *
 */
...
public:
  /**
   * @brief converts the flatbuffer instance query message to seerep core
   * specific message
   * @param query the flatbuffer instance query message
   * @return the query message in seerep core format
   */
  static seerep_core_msgs::Query
  fromFb(const seerep::fb::QueryInstance* queryInstance);
  /**
   ...
   */
  static seerep_core_msgs::Query
  fromFb(const seerep::fb::Query* query,
   ...
   * @return the message in seerep core format for the data needed for the indices
   */
  static seerep_core_msgs::DatasetIndexable
  fromFb(const seerep::fb::PointStamped* point);
   ...
   */
  static seerep_core_msgs::DatasetIndexable
  fromFb(const seerep::fb::PointCloud2& cloud);
  ...
  fromFb(const seerep::fb::TransformStampedQuery& query);

  /**
   * @brief converts the flatbuffer camera intrinsics message to seerep core
   * specific message
  ...
  fromFb(const seerep::fb::CameraIntrinsics& ci);
   ...
   */
  static flatbuffers::Offset<seerep::fb::Header>
  toFb(flatbuffers::grpc::MessageBuilder& mb,
       const seerep_core_msgs::Header header);

  /**
   * @brief Convert seerep core message region of interest to flatbuffer region
   * of interest.
   *
   * @param mb Message builder to be used for building the message
   ...
   */
  static flatbuffers::Offset<seerep::fb::RegionOfInterest>
  toFb(flatbuffers::grpc::MessageBuilder& mb,
   ...
   */
  static flatbuffers::Offset<seerep::fb::Timestamp>
  toFb(flatbuffers::grpc::MessageBuilder& mb,
       const seerep_core_msgs::Timestamp ts);

  /**
   * @brief Convert seerep core message camera intrinsics to flatbuffer camera
   * intrinsics.
   *
   * @param mb Message builder to be used for building the message
   ...
   */
  static flatbuffers::Offset<seerep::fb::CameraIntrinsics>
  toFb(flatbuffers::grpc::MessageBuilder& mb,
       const seerep_core_msgs::camera_intrinsics ci);

  /**
   * @brief Converts a seerep core project info message into the corresponding
   * flatbuffer message
   *
   ...
   */
  static flatbuffers::Offset<seerep::fb::ProjectInfo>
  toFb(flatbuffers::grpc::MessageBuilder& fbb,
       const seerep_core_msgs::ProjectInfo& prjInfo);

  static flatbuffers::Offset<seerep::fb::ProjectInfos>
  toFb(flatbuffers::grpc::MessageBuilder& fbb,
       const std::vector<seerep_core_msgs::ProjectInfo>& prjInfos);

  /**
   * @brief converts the flatbuffer region of interest message to the specific
   * seerep core message
  ...
  fromFb(const seerep::fb::RegionOfInterest& roi);

  /**
   * @brief converts the flatbuffer camera intrinsics message to the specific
   * seerep core message
   *
  ...
  fromFb(const seerep::fb::CameraIntrinsicsQuery& camIntrinsicsQuery);

  static flatbuffers::Offset<seerep::fb::Boundingbox>
  toFb(flatbuffers::grpc::MessageBuilder& mb, seerep_core_msgs::AABB& aabb);

  static flatbuffers::Offset<seerep::fb::TimeInterval>
  toFb(flatbuffers::grpc::MessageBuilder& mb, seerep_core_msgs::AabbTime& aabb);

  /**
   * @brief converts the query result from the seerep core format to gRPC
   * flatbuffer message
   * @param result the query result in seerep core specific format
   * @return the result as gRPC flatbuffer message
   */
  static flatbuffers::grpc::Message<seerep::fb::UuidsPerProject>
  toFb(seerep_core_msgs::QueryResult& result);

  static std::vector<seerep_core_msgs::Datatype>
  fromFbDatatypeVector(const seerep::fb::Datatype& dt);

private:
  /**
   * @brief converts the project part of the flatbuffer query message to seerep
   * core specific message
   * @param query the flatbuffer query message
   * @param queryCoreProjects the projects in the query message in seerep core format
   */
  static void fromFbQueryProject(
      const seerep::fb::Query* query,
      std::optional<std::vector<boost::uuids::uuid>>& queryCoreProjects);
  /**
   * @brief converts the instance part of the flatbuffer query message to seerep
   * core specific message
   * @param query the flatbuffer query message
   * @param queryCoreInstances the instances in the query message in seerep core format
   */
  static void fromFbQueryInstance(
      const seerep::fb::Query* query,
   ...
   */
  static void fromFbQueryDataUuids(
      const seerep::fb::Query* query,
      std::optional<std::vector<boost::uuids::uuid>>& queryCoreDataUuids);
  /**
   * @brief converts the label part of the flatbuffer query message to seerep
   * core specific message
   * @param query the flatbuffer query message
   * @param queryCoreLabel the labels (per category) in the query message in
   * seerep core format
   */
  static void fromFbQueryLabel(
      const seerep::fb::Query* query,
      std::optional<std::unordered_map<std::string, std::vector<std::string>>>&
          queryCoreLabel);
  /**
   * @brief converts the temporal part of the flatbuffer query message to seerep
   * core specific message
   * @param query the flatbuffer query message
   ...
   */
  static std::optional<seerep_core_msgs::SparqlQuery>
  fromFbSparqlQuery(const seerep::fb::Query* query);
  ...
  fromFbOntologyURI(const seerep::fb::Query* query);
   ...
   */
  static void fromFbDataHeader(const seerep::fb::Header* header,
                               seerep_core_msgs::Header& coreHeader,
                               seerep_core_msgs::Datatype&& datatype);

  /**
   * @brief converts (or generates if not set) the msg uuid of the flatbuffer
   * data message to seerep core specific message
  ...
  /**
   * @brief converts the label of the flatbuffer data message to seerep core
   * specific message
   * @param labelFb the label in the flatbuffer data message
   * @param label the llabel (per category) in the data message in seerep core
   * format
   */
