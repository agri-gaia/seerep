...
//   std::unordered_map<std::string, std::vector<seerep_core_msgs::Label>> labelWithInstancePerCategory;
//   for (auto bbWithCategory : *boundingBoxeslabeled.labels_bb())
//   {
//     if (bbWithCategory->boundingBoxLabeled())
//     {
//       std::vector<seerep_core_msgs::Label> labelsWithInstances;
//       for (auto bb : *bbWithCategory->boundingBoxLabeled())
//       {
//         seerep_core_msgs::Label labelWithInstance;
