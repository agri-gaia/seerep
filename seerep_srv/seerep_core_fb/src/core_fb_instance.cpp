...
{
CoreFbInstance::CoreFbInstance(std::shared_ptr<seerep_core::Core> seerepCore)
...
void CoreFbInstance::getInstances(
    ...
    flatbuffers::grpc::Message<seerep::fb::UuidsPerProject>* response)
{
  ...
  seerep_core_msgs::Query queryCore =
      seerep_core_fb::CoreFbConversion::fromFb(request->GetRoot());
