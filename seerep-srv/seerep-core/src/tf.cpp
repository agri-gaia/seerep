...
TF::TF(std::shared_ptr<seerep_hdf5::TfIO> hdf5_io, const seerep::TransformStamped& tf)
  : m_hdf5_io(hdf5_io)
...
TF::TF(std::shared_ptr<seerep_hdf5::TfIO> hdf5_io, const std::string& id) : m_hdf5_io(hdf5_io), m_id(id)
{
