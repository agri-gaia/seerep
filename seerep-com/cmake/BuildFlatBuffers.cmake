# cmake-lint: disable=R0913,R0915,C0113,C0301
#
...
function(
  ...
  foreach(schema ${flatbuffers_schemas})
    ...
    if(NOT
      ...
      # using the _generated suffix due to the issue
      # https://github.com/google/flatbuffers/issues/6864 set(generated_include
      # ${generated_includes_dir}/${filename}_generated.h)
      ...
      list(APPEND generated_headers
           ${generated_includes_dir}/${filename}.grpc.fb.h
      )
  ...
  add_custom_target(
    ${custom_target_name} DEPENDS ${all_generated_files}
                                  ${additional_dependencies}
  )
  ...
  if(NOT
    ...
    set_property(
      TARGET ${custom_target_name} PROPERTY GENERATED_INCLUDES_DIR
                                            ${generated_includes_dir}
    )
    set_property(
      TARGET ${custom_target_name} PROPERTY GENERATED_HEADERS
                                            ${all_generated_headers}
    )
    set_property(
      TARGET ${custom_target_name} PROPERTY GENERATED_GRPC_CC
  ...
  if(NOT
    ...
    set_property(
      TARGET ${custom_target_name} PROPERTY BINARY_SCHEMAS_DIR
                                            ${binary_schemas_dir}
    )
  endif()
  ...
  if(NOT
    ...
    set_property(
      TARGET ${custom_target_name} PROPERTY COPY_TEXT_SCHEMAS_DIR
                                            ${copy_text_schemas_dir}
    )
  endif()
endfunction()
...
function(flatbuffers_generate_headers)
  ...
  add_dependencies(
    ${FLATBUFFERS_GENERATE_HEADERS_TARGET} ${FLATC}
    ${FLATBUFFERS_GENERATE_HEADERS_SCHEMAS}
  )
  target_include_directories(
    ${FLATBUFFERS_GENERATE_HEADERS_TARGET} INTERFACE ${generated_target_dir}
  )
