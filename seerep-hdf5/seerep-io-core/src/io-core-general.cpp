...
{
IoCoreGeneral::IoCoreGeneral(std::shared_ptr<HighFive::File>& file, std::shared_ptr<std::mutex>& write_mtx)
  : m_file(file), m_write_mtx(write_mtx)
{
}

std::optional<seerep_core_msgs::DatasetIndexable> IoCoreGeneral::readDataForIndices(const std::string& datatypeGroup,
...
std::optional<std::string> IoCoreGeneral::readFrameId(const std::string& datatypeGroup, const std::string& uuid)
{
  std::string id = datatypeGroup + "/" + uuid;
...
std::vector<std::string> IoCoreGeneral::getGroupDatasets(const std::string& id)
{
...
void IoCoreGeneral::deleteAttribute(const std::shared_ptr<HighFive::DataSet> dataSetPtr, std::string attributeField)
{
...
void IoCoreGeneral::readAABB(const std::string& datatypeGroup, const std::string& uuid, seerep_core_msgs::AABB& aabb)
{
  std::string id = datatypeGroup + "/" + uuid;
...
bool IoCoreGeneral::hasAABB(const std::string& datatypeGroup, const std::string& uuid)
{
  std::string id = datatypeGroup + "/" + uuid;
...
void IoCoreGeneral::readTimeFromRaw(const std::string& datatypeGroup, const std::string& uuid, int64_t& secs,
                                    int64_t& nanos)
{
  readTime(datatypeGroup, uuid + "/" + RAWDATA, secs, nanos);
}

void IoCoreGeneral::readTime(const std::string& datatypeGroup, const std::string& uuid, int64_t& secs, int64_t& nanos)
{
  std::string id = datatypeGroup + "/" + uuid;
...
void IoCoreGeneral::writeTimeToRaw(const std::string& datatypeGroup, const std::string& uuid, const int64_t& secs,
                                   const int64_t& nanos)
{
  writeTime(datatypeGroup, uuid + "/" + RAWDATA, secs, nanos);
}

void IoCoreGeneral::writeTime(const std::string& datatypeGroup, const std::string& uuid, const int64_t& secs,
                              const int64_t& nanos)
{
  std::string id = datatypeGroup + "/" + uuid;
...
bool IoCoreGeneral::hasTimeRaw(const std::string& datatypeGroup, const std::string& uuid)
{
  return hasTime(datatypeGroup, uuid + "/" + RAWDATA);
}

bool IoCoreGeneral::hasTime(const std::string& datatypeGroup, const std::string& uuid)
{
  std::string id = datatypeGroup + "/" + uuid;
  if (!m_file->exist(id))
  {
...
void IoCoreGeneral::readBoundingBox2DLabeled(const std::string& datatypeGroup, const std::string& uuid,
...
void IoCoreGeneral::readLabelsGeneral(const std::string& datatypeGroup, const std::string& uuid,
                                      std::vector<std::string> labels)
{
  std::string id = datatypeGroup + "/" + uuid;
...
void IoCoreGeneral::writeProjectname(const std::string& projectname)
{
...
std::string IoCoreGeneral::readProjectname()
{
...
void IoCoreGeneral::writeProjectFrameId(const std::string& frameId)
{
...
std::string IoCoreGeneral::readProjectFrameId()
{
  std::string frameId;
  if (m_file->hasAttribute(PROJECTFRAMEID))
  {
