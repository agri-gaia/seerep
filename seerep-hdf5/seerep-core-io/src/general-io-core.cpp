...
{
GeneralIOCore::GeneralIOCore(std::shared_ptr<HighFive::File>& file, std::shared_ptr<std::mutex>& write_mtx)
  : m_file(file), m_write_mtx(write_mtx)
{
}

std::optional<seerep_core_msgs::DatasetIndexable> GeneralIOCore::readDataForIndices(const std::string& datatypeGroup,
...
std::optional<std::string> GeneralIOCore::readFrameId(const std::string& datatypeGroup, const std::string& uuid)
{
  std::string id = datatypeGroup + "/" + uuid;
...
std::vector<std::string> GeneralIOCore::getGroupDatasets(const std::string& id)
{
...
void GeneralIOCore::deleteAttribute(const std::shared_ptr<HighFive::DataSet> dataSetPtr, std::string attributeField)
{
...
void GeneralIOCore::readAABB(const std::string& datatypeGroup, const std::string& uuid, seerep_core_msgs::AABB& aabb)
{
  std::string id = datatypeGroup + "/" + uuid;
...
bool GeneralIOCore::hasAABB(const std::string& datatypeGroup, const std::string& uuid)
{
  std::string id = datatypeGroup + "/" + uuid;
...
void GeneralIOCore::readTimeFromRaw(const std::string& datatypeGroup, const std::string& uuid, int64_t& secs,
                                    int64_t& nanos)
{
  readTime(datatypeGroup, uuid + "/" + RAWDATA, secs, nanos);
}

void GeneralIOCore::readTime(const std::string& datatypeGroup, const std::string& uuid, int64_t& secs, int64_t& nanos)
{
  std::string id = datatypeGroup + "/" + uuid;
...
void GeneralIOCore::writeTimeToRaw(const std::string& datatypeGroup, const std::string& uuid, const int64_t& secs,
                                   const int64_t& nanos)
{
  writeTime(datatypeGroup, uuid + "/" + RAWDATA, secs, nanos);
}

void GeneralIOCore::writeTime(const std::string& datatypeGroup, const std::string& uuid, const int64_t& secs,
                              const int64_t& nanos)
{
  std::string id = datatypeGroup + "/" + uuid;
...
bool GeneralIOCore::hasTimeRaw(const std::string& datatypeGroup, const std::string& uuid)
{
  return hasTime(datatypeGroup, uuid + "/" + RAWDATA);
}

bool GeneralIOCore::hasTime(const std::string& datatypeGroup, const std::string& uuid)
{
  std::string id = datatypeGroup + "/" + uuid;
  if (!m_file->exist(id))
  {
...
void GeneralIOCore::readBoundingBox2DLabeled(const std::string& datatypeGroup, const std::string& uuid,
...
void GeneralIOCore::readLabelsGeneral(const std::string& datatypeGroup, const std::string& uuid,
                                      std::vector<std::string> labels)
{
  std::string id = datatypeGroup + "/" + uuid;
...
void GeneralIOCore::writeProjectname(const std::string& projectname)
{
...
std::string GeneralIOCore::readProjectname()
{
...
void GeneralIOCore::writeProjectFrameId(const std::string& frameId)
{
...
std::string GeneralIOCore::readProjectFrameId()
{
  std::string frameId;
  if (m_file->hasAttribute(PROJECTFRAMEID))
  {
