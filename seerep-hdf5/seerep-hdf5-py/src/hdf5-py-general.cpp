...
std::vector<seerep_hdf5_py::GeneralLabel> Hdf5PyGeneral::readLabelsGeneral(const std::string& data_group_id)
{
  auto hdf_group_ptr = getHdf5Group(data_group_id);

  std::vector<seerep_hdf5_py::GeneralLabel> general_labels;
