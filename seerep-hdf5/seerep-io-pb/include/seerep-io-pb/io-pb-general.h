#ifndef SEEREP_IO_PB_IO_PB_GENERAL_H_
#define SEEREP_IO_PB_IO_PB_GENERAL_H_
...
{
public:
  IoPbGeneral(std::shared_ptr<HighFive::File>& file, std::shared_ptr<std::mutex>& write_mtx);
...
#include "impl/io-pb-general.hpp"  // NOLINT

#endif /* SEEREP_IO_PB_IO_PB_GENERAL_H_ */
